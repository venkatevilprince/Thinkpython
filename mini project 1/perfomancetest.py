...
#       print line
test_url = 'https://www.google.co.in/?gfe_rd=cr&ei=Y-egVbHYHK7v8wfdoJ6oAQ&gws_rd=ssl#q=fastest+way+to+read+html+from+website+python'

def get_links_from_url(web_url):
    print web_url
    start = time.time()
    conn = urllib2.urlopen(web_url)
